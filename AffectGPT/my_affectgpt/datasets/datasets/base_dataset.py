    ...
    def __init__(self, vis_processor=None, txt_processor=None, img_processor=None, model_cfg=None, dataset_cfg=None,
        ...
        if self.use_realtime_extraction:
            ...
            if any_pre:
                ...
                print(f'- Frame: {"ON" if self.use_preextracted_frame else "OFF"}')
                print(f'- Face:  {"ON" if self.use_preextracted_face else "OFF"}')
                print(f'- Audio: {"ON" if self.use_preextracted_audio else "OFF"}')
