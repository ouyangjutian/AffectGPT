...
def func_return_scores_one(modelname=None, dataset_candidates='affectgpt'):
    ...
    for dataset in process_datasets:
        ...
        process_root = f"output/log_information/emercoarse_highlevelfilter4_outputhybird_bestsetup_bestfusion_lz_face_frame/peak/inference_result/results-{dataset}/{modelname}"
        ## 计算指标
...
if __name__ == "__main__":
    ...
    #                 ]:
    for modelname in [
                    'emercoarse_highlevelfilter4_outputhybird_bestsetup_bestfusion_lz_face_frame_peak',
                    ]:                    
        for dataset in ["mer2023", "mer2024", "meld", "iemocapfour", "cmumosi", "cmumosei", "sims", "simsv2", "ovmerdplus"]:
            ...
            main_zeroshot_scores(f"output/log_information/emercoarse_highlevelfilter4_outputhybird_bestsetup_bestfusion_lz_face_frame/peak/inference_result/results-{dataset}/{modelname}")
